...
//TPM0通道1引脚
#define TPM0_CH1  (PORT_A|4) //(PORTA|4),(PORTC|2),(PORTD|1),(PORTE|25)
//TPM0通道2引脚
#define TPM0_CH2  (PORT_A|5) //(PORTA|5),(PORTC|3),(PORTD|2),(PORTE|29)
//TPM0通道3引脚
#define TPM0_CH3  (PORT_C|4) //(PORTC|4),(PORTD|3),(PORTE|30)
//TPM0通道4引脚
#define TPM0_CH4  (PORT_C|8) //(PORTC|8),(PORTD|4),(PORTE|31)
//TPM0通道5引脚
#define TPM0_CH5  (PORT_A|0) //(PORTA|0),(PORTC|9),(PORTD|5)
//-------------------------------------------------

//---------------TPM1通道引脚选择----------------------
//TPM1通道0引脚
#define TPM1_CH0  (PORT_A|12)  //(PORTA|12),(PORTB|0),(PORTE|20)
//TPM1通道1引脚
#define TPM1_CH1  (PORT_A|13)  //(PORTA|13),(PORTB|1),(PORTE|21)
//--------------------------------------------------

//------------------TPM2通道引脚选择-------------------
//TPM2通道0引脚
#define TPM2_CH0  (PORT_B|18)  //(PORTA|1),(PORTB|2),(PORTB|18),(PORTE|22)
//TPM2通道1引脚
#define TPM2_CH1  (PORT_B|19)  //(PORTA|2),(PORTB|3),(PORTB|19),(PORTE|23)
//---------------------------------------------------
